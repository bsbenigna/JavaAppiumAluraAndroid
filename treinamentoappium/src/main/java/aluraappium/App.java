...
public class App
{
    public static void main( String[] args ) throws MalformedURLException {
        File apk = new File("C:\\Users\\benignaBernardes\\Documents\\Treinamento Appium\\Treinamento Alura\\treinamentoappium-aula1\\src\\main\\resources\\alura_esporte.apk");
        ...
        configuracoes.setCapability(MobileCapabilityType.PLATFORM_VERSION,"9");
